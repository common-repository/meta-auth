 ...
 */
final class Meta_Auth_Setup_ToS
{
    const SLUG = 'meta-auth-tos';
    ...
    {
        ?>
        <div class="wrap meta-auth-tos-page">
            <h1 style="font-size:24px;text-transform:uppercase;font-weight:700">
                <?= __('Terms and Conditions of Use', AUTH_PLUGIN); ?>
            </h1>

            <p>These Terms and Conditions (the “<strong>Agreement</strong>”) govern your use of MetaAuth (the "Plugin")
    ...
    public function enqueue_assets($hook_name)
    {
        ...
        wp_add_inline_style('dashicons', '#wpcontent #wpbody p,#wpcontent #wpbody li {font-size:14px}#wpcontent #wpbody #wpbody-content .notice {display: none}.wp-admin .meta-auth-tou-page h2 {font-size:1.75em}#wpcontent #wpbody li{list-style:disc}#wpcontent #wpbody .nested-list li {list-style:circle}');
    }
}

Meta_Auth_Setup_ToS::init();